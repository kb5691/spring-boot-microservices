package hello.authorapi.controllers;
...
import hello.authorapi.services.AuthorService;
...
public class AuthorController {
  ...
  public ResponseEntity<AuthorDto> createAuthor(@Valid @RequestBody CreateAuthorDto dto) {
    ...
    URI location = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(newAuthor.getId()).toUri();
