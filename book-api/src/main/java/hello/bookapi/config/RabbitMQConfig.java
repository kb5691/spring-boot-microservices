...
public class RabbitMQConfig {
  ...
  public FanoutExchange bookCreatedExchange() {
    return new FanoutExchange(RabbitMQKeys.BOOK_CRATED_EXCHANGE);
  }
  ...
  @Bean
  public Binding authorUpdatedBinding(Queue authorUpdatQueue, FanoutExchange authorUpdatedExchange) {
    return BindingBuilder
      .bind(authorUpdatedExchange)
